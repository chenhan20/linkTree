...
- **暖橘系 7 個重複值**應收斂進 `#FC4C02`：`#ff7040`(4) `#ff8a3d`(3) `#ff7a3c`(2) `#ff6b35`(2) `#ff6a00`(2) `#ffb066`(2) `#ff9142`。
...
主卡與彈窗四角的 L 形細線（10–18px、1.5–2px、訊號橘）。純裝飾但是全系統的識別記號，來自 HUD 取景框。用於：功率卡、路段彈窗、功率彈窗。

...
> | ITT 計時 | 靠 Strava 配對，**會漏** | 自建偵測器，實測還抓到 Strava 漏掉的 |
> | 額度 | 100 req / 15 分、1000 / 日 | 5000 / 日、2500 / 15 分 |
>
> 實測 2026-08-13 那趟，自建偵測器抓到「關渡→美堤 25:07」，
> Strava 全史 **0 筆**。同一趟另一條路段兩邊只差 0.6 秒 —— 偵測器是準的，
> 是 Strava 沒配對到。**去 Strava 化不但不會失去資料，還會拿到 Strava 沒給的。**
>
> ### 現在還靠 Strava 的只剩三件事
>
